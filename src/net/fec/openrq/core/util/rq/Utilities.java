...
public final class Utilities {
     ...
     * @return C
     */
    public static void multiplyMatricesHack(byte[][] A, int first_rowA, int first_colA, int last_rowA, int last_colA,
        byte[][] B, int first_rowB, int first_colB, int last_rowB, int last_colB,
        byte[][] C, int first_rowC, int first_colC, int last_rowC, int last_colC) {
     ...
     * @return
     */
    public static byte[] multiplyByteLineBySymbolVector(byte[] line, int line_length, byte[][] vector) {
     ...
     * @return
     */
    public static byte[] multiplyByteLineBySymbolVector(byte[] line, int line_length,
        int[] d, byte[][] D) {
    ...
    public static void xorSymbolInPlace(byte[] s1, byte[] s2) {
    ...
    public static boolean validateRank(
        byte[][] matrix,
        int first_row,
        int first_col,
        int last_row,
...
//            }
     ...
     * @param overhead
     *            Number of overhead repair symbols necessary for decoding.
     * @param loss
     *            The expected network loss rate (in %).
